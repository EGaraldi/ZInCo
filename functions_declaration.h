...
void Read_ICs_File(char[], int, io_header&, vector<particle_data>&, vector<LOIinHigh>&, bool[]);
void Read_Snap_File(char[], int, io_header&, vector<particle_data>&, vector<LOIinLow>&, bool[]);
