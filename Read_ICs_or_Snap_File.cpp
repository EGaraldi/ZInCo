...
void Read_ICs_File(char fname[], int ftype, io_header& header, vector<particle_data>& particles, vector<LOIinHigh>& id, bool things_to_read[]){
...
void Read_Snap_File(char fname[], int ftype, io_header& header, vector<particle_data>& particles, vector<LOIinLow>& id, bool things_to_read[]){
